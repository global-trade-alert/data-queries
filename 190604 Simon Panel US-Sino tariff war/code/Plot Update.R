...
corrected.plot <- ggplot()+
  ...
  scale_y_continuous(breaks=seq(0,500,50), limits = c(0,300),sec.axis = sec_axis(~.*(1/300), name = "Share of Chinese exports affected"))+
...
gta_plot_saver(plot=corrected.plot,
               path=output.path,
               name="Comparison of administrations in the US-Sino tariff war (base 2005-2007)")
