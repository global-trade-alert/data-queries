...
#IMPORTANT  
#database replica - parts - base.Rdata is still correct right? there's one which is called
#2019-09-03_933 but is only 1 minute newer, I guess base was updated at same time
#this code is left fully intact from when JF wrote it 
...
save(trade.coverage.estimates, file=paste0(data.path,"P estimates.Rdata"))
